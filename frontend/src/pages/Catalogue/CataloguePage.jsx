    ...
    <div style={{ display: 'flex', minHeight: '100vh', marginLeft: '250px', backgroundColor: '#f8fafc' }}>
      ...
      <main style={{ flex: 1, padding: '32px', overflowY: 'auto' }}>
        <header style={{ marginBottom: '30px' }}>
          <h1 style={{ fontSize: '32px', color: '#1e293b', margin: '0 0 8px 0', fontWeight: '700' }}>📚 Catalogue</h1>
          <p style={{ color: '#64748b', margin: 0, fontSize: '16px', fontWeight: 500 }}>Browse available resources and services.</p>
        </header>

        <div style={{ marginTop: '20px', padding: '24px', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
          <p style={{ color: '#64748b', margin: 0 }}>Catalogue features will be available soon.</p>
        </div>
      </main>
    </div>
  )
